...
<html lang="en" dir="ltr">
  ...
  <body>
      <header>
        <img src="https://cdn.shortpixel.ai/client/q_lossy,ret_img,w_250,h_145/https://www.lamolisana.it/wp-content/uploads/2020/05/marchio-sito-test.png" alt="pasta">
        <nav>
          <ul>
      ...
      <main>
            ...
            <div class="cards">
              ...
              @foreach ($lunghe as $value)
                <div class="card">
                  <h3>{{$value['titolo']}}</h3>
                  <img src="{{$value['src']}}" alt="{{$value['titolo']}}">
                </div>
              @endforeach
            </div>
            <h1>corte</h1>
